...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(df[(df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])) & (df['salary'] == '>50K')].shape[0] / higher_education * 100, 2)
    ...
    rich_per_country_percentage = rich_per_country / total_per_country * 100
    highest_earning_country = rich_per_country_percentage.idxmax()
    highest_earning_country_percentage = round(rich_per_country_percentage.max(), 2)
